...
/* Defines the section of the map that is currently visbible, acting as viewport into game space.
...
impl Camera {
    ...
    /* on_player_move: update the camera as the player moves */
    pub fn on_player_move(& mut self, player_position: Point) {
        /* Must be i32 values as may hold a negative number (viewport may exceed boundaries when
         * player on edges of the screen, but those tiles will not be rendered) */ 
